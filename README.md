# appx
appx 是一个功能强大的 web 服务搭建框架，内置配置中心、API 路由、日志格式化等功能，帮助开发者快速构建高性能、可扩展的微服务应用。
...
```
go get github.com/go-xuan/appx
```
...
func HttpServer() *serverx.HttpServer {
	return serverx.NewHttpServer(ginx.HttpServer(
